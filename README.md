...
CausFate uses GRN-free feature perturbation by default and does not require CellOracle. For GRN-based perturbation, generate a compatible `ref_GRN` using CellOracle and provide it to CausFate.
